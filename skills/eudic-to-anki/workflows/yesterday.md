...
8. 预演：`python3 scripts/ankiconnect_import.py --input <ABS_TEMP_DIR>/_day_<D>_import.json --deck words --create-deck --dia-upsert --verify-required-fields --dry-run`
9. 使用 `SKILL.md` 的 Edge-TTS 命令真实导入。音频第二次失败时停止，不得使用系统 TTS。
