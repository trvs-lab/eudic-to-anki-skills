...
2. Export words:
  - `python3 scripts/eudic_export.py --all-categories --start-date <D> --end-date <D> --format csv --output ~/Documents/eudic-to-anki-temp/_day_<D>_export.csv`
3. Build placeholder + author coach:
  - `python3 scripts/build_dia_json_from_csv.py --csv ~/Documents/eudic-to-anki-temp/_day_<D>_export.csv --output ~/Documents/eudic-to-anki-temp/_day_<D>_partial.json --batch-date <D> --eudic-words-only`
